...
-make nested if else statement for middle using two && things

last note this code does completely work if you just type 1 2 3 in order it wont show middle number for some reason but any other instance it will
*/
