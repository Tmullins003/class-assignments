// This program displays right 4 different right triangles
...
int main()
{
    ...
    {
        for (f=1;f<=e;++f) // for loop dependent on variable l
        {
    ...
    for (j = 1; j <= 10; j++) // for loop starts at 1 and increases in increments of one until ten then stops loop
	{
        ...
        for(i = 1; i <= j; i++) // for loop dependent on variable j
        {
			cout << "*" << " "; // displays *s and spaces
        }
...
//
//  initialize for loop using variable e starting at 1 and increases in increments of 1 until 10 then stops loop {
